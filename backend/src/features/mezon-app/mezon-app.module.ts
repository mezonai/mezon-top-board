...
import { App, AppVersion, Link, LinkType, Rating, Tag, User, UserFavorite } from "@domain/entities";
...
@Module({
  imports: [TypeOrmModule.forFeature([App, Tag, User, Rating, Link, LinkType, AppVersion, UserFavorite]), AppVersionModule],
