...
export class AppVersionUpdate1761799279833 implements MigrationInterface {
    name = 'AppVersionUpdate1761799279833'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "app" ADD "currentVersion" integer`);
        await queryRunner.query(`ALTER TABLE "app" ADD "hasNewUpdate" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "app_review_history" ADD "appVersionId" uuid NOT NULL`);
