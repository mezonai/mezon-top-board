...
export class AddTempSourceFileEntity1764659847423 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "temp_source_file" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "fileName" character varying NOT NULL, "filePath" character varying, "status" "public"."temp_source_file_status_enum" NOT NULL DEFAULT 'PROCESSING', "completedAt" TIMESTAMP, "ownerId" uuid, CONSTRAINT "PK_3f9d0ed219f2fb08e69970db7ce" PRIMARY KEY ("id"))`);
