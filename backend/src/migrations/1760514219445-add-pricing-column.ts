...
export class AddPricingColumn1760514219445 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."app_pricingtag_enum" AS ENUM('FREE', 'PAID')`);
        await queryRunner.query(`ALTER TABLE "app" ADD "pricingTag" "public"."app_pricingtag_enum" NOT NULL DEFAULT 'FREE'`);
